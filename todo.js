...
/*This Function adds the inputed taask to get_todos function array*/
function add() {
    ...
    todos.push(task);
    /* this converts the tast input to a JSON string*/
...
/*this fuction keeps the tasks permanetly displayed on the screen*/
function show() {
...
show();
/*this creates the functinality of removing a todo item from the array*/
function remove() {
    var id =this.getAttribute('id');
    var todos =get_todos();
    todos.splice(id,1);
